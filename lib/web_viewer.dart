...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  void _onItemTapped(int index){
    ...
    String str = "";
    debugPrint('Page finished loading Nasir: ${context.read<CountProvider>().url}');
    ...
    _controller.loadRequest(LoadRequestParams(uri: Uri.parse(str),));
  }
  ...
  void initState() {
    ...
    _controller = PlatformWebViewController(
      ...
      ..setBackgroundColor(const Color(0x80AECCFF))
      ...
      ..loadRequest(
        LoadRequestParams(
          uri: Uri.parse('https://rpms.reena.org'),
        ),
      );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Welcome to RPMS'),
